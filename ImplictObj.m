...
%ImplictObj: A misspelled function that I can't be bothered to change
%Takes a set of heat transfer coefficients and produces simulated data.
% Simulated data is then quantitaviley compared to real data to produce error 
load('params.mat');
